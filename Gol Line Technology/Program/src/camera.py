...
def main():
    # Menggunakan DroidCam sebagai sumber input video
    # Ganti <IP> dan <Port> dengan informasi dari DroidCam (contoh: http://192.168.1.2:4747/video)
    video_path = "http://<IP>:<192.168.32.24>/video"  # Untuk Wi-Fi
    # video_path = "/dev/video2"  # Jika menggunakan USB dan device tersedia
    ...
    if not cap.isOpened():
        print("Tidak dapat membuka DroidCam. Periksa koneksi dan pastikan URL atau device path benar.")
        return
